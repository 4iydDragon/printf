	...
	int flags, int width, int precision, int size)
{
	...
	return (write_the_num(ind, buffer, flags, width, precision,
 ...
 */
int write_the_num(int ind, char buffer[],
...
/**
 * write_the_unsigned - Writes an unsigned number
...
/**
 * write_the_pointer - Write a memory address
